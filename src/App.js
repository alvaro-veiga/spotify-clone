...
import { DotsThree, Play, UsersThree, House, MagnifyingGlass,Books, ArrowRight, Plus, CaretDown, CaretLeft, CaretRight, Heart} from "@phosphor-icons/react";
    ...
    <div className="bg-gradient-to-b from-yellow-400/70 from-10% via-zinc-900 via-30% to-zinc-900 to-100% text-zinc-50 h-screen flex flex-col">
      <div className="flex flex-1 overflow-hidden">
            ...
            <div className="overflow-y-auto" style={{height:660}}>
              ...
              <div className="p-4 space-y-2">
                <a href="" className="flex item-center rounded-lg hover:bg-white/5">
                  <img src="/cover1.jpg" alt="Album Cuphead" width={50} height={50} className="rounded-lg"/>
                  <div>
                    <p className="pl-2 font-semibold line-clamp-1 text-green-500">Cuphead - Original Soundtrack</p>
                    <p className="pl-2 text-sm text-zinc-400 line-clamp-1">Álbum • Chistopher Larkin</p>
                  </div>
                </a>
                <a href="" className="flex item-center rounded-lg hover:bg-white/5">
                  <img src="/cover1.jpg" alt="Album Cuphead" width={50} height={50} className="rounded-lg"/>
                  <div>
                    <p className="pl-2 font-semibold line-clamp-1">Cuphead - Original Soundtrack</p>
                    <p className="pl-2 text-sm text-zinc-400 line-clamp-1">Álbum • Chistopher Larkin</p>
                  </div>
                </a>
                <a href="" className="flex item-center rounded-lg hover:bg-white/5">
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          <div className="flex justify-between">
            ...
            <div className="flex gap-2">
              ...
              <a href="" className="rounded-full bg-black/40 p-1">
                <img src="fotinha.png" alt="foto" width={30} height={25} className="rounded-full"/>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3  gap-4">
            <a href="" className="bg-white/10 group rounded overflow-hidden flex items-center hover:bg-white/20 transition-colors">
              <img src="cover1.jpg" alt="cuphead" width={104} height={104} />
              <strong className="pl-3 line-clamp-1"> Cuphead Original Soundtrack</strong>
          ...
          <h2 className="font-semibold text-3xl mt-10 mb-4">Feita para o davi</h2>
        ...
        <div className="w-96 px-6 flex">
          <img src="cover1.jpg" alt="cuphead" width={70} height={70} />
          <div className="album mr-4 flex flex-col justify-center">
            <p className="pl-2 font-semibold line-clamp-1">Cuphead - Original Soundtrack</p>
            <p className="pl-2 text-sm text-zinc-400 line-clamp-1">Álbum • Chistopher Larkin</p>
          </div>
